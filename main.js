...
ctx.lineWidth  = 5;
ctx.arc(x=250, y=210, r=40, startAngle=-4, endAngle= Math.PI);
ctx.stroke();
...
ctx.lineWidth  = 5;
ctx.arc(x=350, y=210, r=40, startAngle=-4, endAngle= Math.PI);
ctx.stroke();
...
ctx.strokeStyle = "red";
ctx.lineWidth  = 5;
ctx.arc(x=450, y=210, r=40, startAngle=-4, endAngle= Math.PI);
ctx.stroke();
...
ctx.lineWidth  = 5;
ctx.arc(x=300, y=250, r=40, startAngle=-4, endAngle= Math.PI);
ctx.stroke();
...
ctx.lineWidth  = 5;
ctx.arc(x=400, y=250, r=40, startAngle=-4, endAngle= Math.PI);
ctx.stroke();
